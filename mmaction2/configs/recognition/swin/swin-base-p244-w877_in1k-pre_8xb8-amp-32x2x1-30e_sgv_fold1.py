...
data_root = 'data_down_1fps_train'
data_root_val = 'data_down_1fps_train'
ann_file_train = 'annotations/fold_4/train_video.txt'
ann_file_val = 'annotations/fold_4/val_video.txt'
