...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            'https://download.openmmlab.com/mmaction/v1.0/recognition/uniformerv2/uniformerv2-base-p16-res224_clip-kinetics710-pre_8xb32-u8_kinetics400-rgb/uniformerv2-base-p16-res224_clip-kinetics710-pre_8xb32-u8_kinetics400-rgb_20230313-75be0806.pth',  # noqa: E501
            prefix='backbone.')),
    cls_head=dict(
        type='UniFormerHead',
        dropout_ratio=0.5,
        ...
        'configs/recognition/uniformerv2/custom/map_custom.json',
        init_cfg=dict(
            type='Pretrained',
            checkpoint=  # noqa: E251
            'https://download.openmmlab.com/mmaction/v1.0/recognition/uniformerv2/uniformerv2-base-p16-res224_clip-kinetics710-pre_8xb32-u8_kinetics400-rgb/uniformerv2-base-p16-res224_clip-kinetics710-pre_8xb32-u8_kinetics400-rgb_20230313-75be0806.pth',  # noqa: E501
...
ann_file_train = 'data/custom/annotations/version 2/fold_1/train_video.txt'
...
param_scheduler = [
    dict(
        type='MultiStepLR',
        begin=0,
        end=10,  # change from 100 to 50
        by_epoch=True,
        milestones=[4, 8],  # change milestones
        gamma=0.1)
]
