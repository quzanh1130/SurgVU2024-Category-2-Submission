...
execute_in_docker = False  # Change to True if running in Docker
...
class SurgVUClassify:
    ...
    def split_video(self, video_path: str, window_size: int, overlap: int, output_dir: str) -> List[Tuple[str, float, float]]:
        ...
        Args:
            ...
            window_size (int): Duration (in seconds) of each video chunk.
            overlap (int): Duration (in seconds) of overlap between consecutive chunks.
        ...
        while start_frame < total_frames:
            ...
            if not osp.exists(chunk_filename):
    ...
    def post_process_predictions(self, chunk_results, overlap):
        """
        Post-processes the predictions from video chunks to generate frame-level predictions.
        Args:
            ...
            - result (str): The predicted surgical step for the chunk.
        ...
        Returns:
            None: The function saves the frame-level predictions to a JSON file specified by `self.output_file`.
        """
...
if __name__ == "__main__":
    ...
    video_file = detector.input_path / "vid_1_short.mp4"
